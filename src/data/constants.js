...
export const SCHOOL_INFO = {
  name: 'Believers Church Residential School',
  shortName: 'BCRS',
...
export const VISION_MISSION = {
  vision: 'To nurture confident, compassionate, and capable individuals who are prepared to face global challenges while living by strong moral and ethical values.',
  mission: [
    'To deliver holistic education that integrates academics, values, and practical life skills',
    'To encourage critical thinking, creativity, and lifelong learning',
    'To provide a safe, supportive, and inclusive residential environment',
    'To guide students to become responsible citizens and future leaders'
  ]
};
...
export const KEY_FEATURES = [
  {
    ...
    description: 'Student-centered teaching methods and experienced faculty promote curiosity, understanding, and application of knowledge.',
    icon: '📚'
  },
  {
    id: 2,
    title: 'Character & Values',
    description: 'Principles of honesty, respect, compassion, discipline, and service are woven into everyday school life.',
    icon: '🌟'
  },
  {
    id: 3,
    title: 'Co-Curricular Activities',
    description: 'Wide range of sports, cultural programs, and activities develop physical fitness, creativity, and leadership.',
    icon: '🏆'
  },
  {
    id: 4,
    title: 'Safe Environment',
    description: 'Disciplined campus with attentive staff, clear policies, and caring approach ensures student security.',
    icon: '🛡️'
  }
];
...
export const NOTICES = [
  ...
  },
  {
    id: 2,
    date: 'FEB 02, 2026',
    title: 'Spring Semester Begins - New Timetable Released'
  },
  {
    id: 3,
    date: 'FEB 10, 2026',
...
export const PRINCIPALS_MESSAGE = {
  message: `Education is not merely the acquisition of knowledge but the development of character, values, and a sense of purpose. At our school, we strive to create an environment where students are encouraged to explore their talents, think independently, and grow into confident and responsible individuals.

Our dedicated team of teachers and staff work tirelessly to provide a balanced education that nurtures academic excellence while instilling moral values and discipline. We believe that every child is unique and possesses immense potential. Our role is to guide, inspire, and support them as they discover their strengths and prepare for the future.

We value the partnership between parents and the school and believe that open communication and mutual trust are essential for a child's success. Together, let us help our students grow into compassionate, skilled, and principled individuals who will make a positive contribution to society.

I warmly invite you to be a part of the Believers Church Residential School family.`,
  signature: 'Principal',
